package br.com.anotacoes.teste;
...
public class TesteString {
	...
	public static void main(String[] args) {
		...
		//.contains, serve para perguntar se tem certos caracteres na string
		//ele devolvera em boolean
		System.out.println(nome.contains("Aluu"));
